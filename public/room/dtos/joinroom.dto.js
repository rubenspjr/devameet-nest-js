...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: room_messages_helper_1.RoomMessagesHelper.JOIN_USER_NOT_VALID }),
    __metadata("design:type", String)
], JoinRoomDto.prototype, "userId", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: room_messages_helper_1.RoomMessagesHelper.JOIN_LINK_NOT_VALID }),
    __metadata("design:type", String)
