...
const messages_helper_2 = require("../user/helpers/messages.helper");
...
let AuthService = AuthService_1 = class AuthService {
    ...
    async login(dto) {
        ...
        if (user == null) {
            throw new common_1.BadRequestException(messages_helper_1.MessagesHelper.AUTH_PASSWORD_OR_LOGINF_NOT_FOUND);
        }
    ...
    async register(dto) {
        ...
        if (await this.userService.existsByEmail(dto.email)) {
            throw new common_1.BadRequestException(messages_helper_2.UserMessagesHelper.REGISTER_EXIST_EMAIL_ACCOUNT);
        }
